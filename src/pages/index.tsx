  ...
  return (
    <>
      ...
      <main>
        ...
        <div id="featured-projects" className="mx-auto max-w-4xl py-20 sm:py-28 lg:py-36">
          <h2 className="text-center text-3xl font-medium tracking-tight text-black sm:text-4xl py-7">Featured Projects</h2>
          <ul role="list" className="grid grid-cols-1 gap-6 sm:grid-cols-2">
            <li className="col-span-2 divide-y divide-gray-200 rounded-lg bg-white shadow">
              <div className="flex w-full items-center justify-between space-x-6 p-6">
                <div className="flex-1">
                  <div className="flex items-center space-x-3">
                    <h3 className="text-base font-medium text-gray-900">Touchless T-Rex Runner</h3>
                  </div>
              ...
              <div>
                <div className="-mt-px flex divide-x divide-gray-200">
                  <div className="flex w-0 flex-1">
                    <a href="https://sergenkaraoglan.github.io/t_rex_runner_touchless_interface/" className="relative -mr-px inline-flex w-0 flex-1 items-center justify-center rounded-bl-lg border border-transparent py-4 text-sm font-medium text-gray-700 hover:text-gray-500">
                  ...
                  <div className="-ml-px flex w-0 flex-1">
                    <a href="https://github.com/SergenKaraoglan/t_rex_runner_touchless_interface" className="relative inline-flex w-0 flex-1 items-center justify-center rounded-br-lg border border-transparent py-4 text-sm font-medium text-gray-700 hover:text-gray-500">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
