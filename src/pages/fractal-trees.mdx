...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:idle initDepth={1} showDepth={true} />
</div>
...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:idle initDepth={10} showAngle={true} />
</div>
...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:idle initDepth={10} showShape={true} />
</div>
...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:idle is3D={true} initDepth={5} />
</div>
