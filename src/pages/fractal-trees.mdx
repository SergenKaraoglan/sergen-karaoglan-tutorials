...
import RotationCanvas from "../components/rotation-points";

<Layout title="Fractal Trees | Sergen Karaoglan" description="Build fractal trees with a interactive 3D fractal tree generator.">
...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:visible initDepth={1} showDepth={true} />
</div>
...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:visible initDepth={10} showAngle={true} />
</div>
...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:visible initDepth={10} showShape={true} />
</div>
...
<div className="m-auto sm:w-96 sm:h-96 py-12">
  <RotationCanvas client:visible />
</div>
...
<div className="m-auto sm:w-96 sm:h-96 py-10">
  <FractalTreeCanvas client:visible is3D={true} initDepth={5} />
</div>
