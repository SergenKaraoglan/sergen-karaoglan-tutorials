...
import DOMTree from "../../components/DOM-Tree.astro";
import RGB from "../../components/RGB.svelte";
import Layout from "../../layouts/home-layout.astro";

<Layout title="HTML and CSS Fundamentals | Sergen Karaoglan" description="Learn the fundamentals of CSS and HTML">
