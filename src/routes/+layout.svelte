...
const navigation = {
  social: [
    ...
    // {  
    //   name: "Twitter",
    //   href: "https://twitter.com/SergenKaraogla2",
    ...
    //   svg: "M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z",
    // },
  ],
};
...
<footer class="bg-white" aria-labelledby="footer-heading">
    ...
    <div
        class="border-t border-gray-900/10 pt-8 lg:flex lg:items-center lg:justify-between"
    >
        <div>
        ...
        class="relative flex items-center mt-4 max-w-fit lg:mt-0 rounded-md bg-blue-700 px-3.5 py-1.5 text-base font-semibold leading-7 text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400"
        >
        <p>{email}</p>
        <div class="ml-2 sm:ml-4 sm:flex-shrink-0">
            <svg id="clipboard" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
